...
(function () {
  ...
  Office.initialize = function (reason) {
    ...
    //var dialogOptions = { width: 20, height: 40, displayInIframe: true };
      //Office.context.ui.displayDialogAsync('https://localhost:3000/src/settings/dialog.html', {height: 30, width: 20, displayInIframe: true},function (asyncResult) {
        //console.log("Inside dialog");
        //console.log(asyncResult.value);
        //var settingsDialog = asyncResult.value;
        //settingsDialog.addEventHandler(Office.EventType.DialogMessageReceived, processMessage);
    //});-->
      setTimeout(function(){
        encryptMail();
      }, 3000);
      ...
      setTimeout(function(){item.close()},3000);
